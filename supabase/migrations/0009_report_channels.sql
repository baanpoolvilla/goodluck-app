...
alter table public.users add column channel report_channel;
...
alter table public.daily_reports add column channel report_channel;
...
-- indexes ---------------------------------------------------------------------
create index idx_daily_reports_channel_date
...
create index idx_report_reactions_report
